...
# load soft effects
sound_1 = pygame.mixer.Sound('week8/lecture/pygame_tutorial/asset/sound_1.wav')
sound_2 = pygame.mixer.Sound('week8/lecture/pygame_tutorial/asset/sound_2.wav')
...
# background music
pygame.mixer.music.load('week8/lecture/pygame_tutorial/asset/music.wav')

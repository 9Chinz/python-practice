...
# Load Image
original_ship_image = pygame.image.load("week8/lecture/pygame_tutorial/asset/dragon_left.png")
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            running = False
    print(ship_ract.left, ship_ract.right)
    # รับคีย์ต่อเนื่อง
    ...
    if not isJump:  # Checks is user is not jumping
        ...
        if jumpCount >= -10:
            ship_ract.y -= (jumpCount * abs(jumpCount)) * 0.9
